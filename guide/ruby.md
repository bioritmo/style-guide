...
This guide is based on [bbatsov's Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide)

[Há uma versão em Português deste guia.](ruby.pt-BR.md)
...
* <a name="spaces-operators"></a>
  Use spaces around operators and equal/unequal signs, after commas, colons and semicolons.
...
<sup>[[link](#spaces-braces)]</sup>
  ...
  Use spaces around `{` and before `}` for hash literals.
...
* <a name="tomdoc-conventions"></a>
    Use [Tomdoc][tomdoc] and its conventions for API documentation.  Don't put an
    empty line between the comment block and the `def`.
<sup>[[link](#tomdoc-conventions)]</sup>
...
* <a name="hash-syntax"></a>
  Use Ruby 1.9+ hash syntax
<sup>[[link]](#hash-syntax)</sup>
...
* <a name="snake-case-methods-and-vars"></a>
  Use `snake_case` for naming methods and variables, e.g. `def some_method`.
<sup>[[link]](#snake-case-methods-and-vars)</sup>
...
* <a name="no-types-in-names"></a>
  Avoid types in names, e.g. `def name_string`
<sup>[[link]](#no-types-in-names)</sup>
