...
* Revisar Pull Requests pode ser mais importante que abrir o seu próprio. Você deverá ter o hábito de ajudar seus(suas) colegas a lançar ótimas features e código de qualidade, e vice-versa. Revisar Pull Requests não é algo que deve ser feito no seu tempo livre - deve ser parte do seu fluxo diário. E lembre-se que dedicar sua atenção e tempo para revisar o trabalho de outra pessoa é a maior prova que você se importa com o trabalho dela.

### Seu Pull Request Revisado

Mais cedo ou mais tarde você vai abrir um Pull Request. É parte do seu fluxo de trabalho, como já mencionamos. Todos vão ter a oportunidade de revisar suas mudanças. Discussões serão levantadas, exemplos de código serão mostrados, experiências serão compartilhadas. Tudo é parte do processo de revisão.
...
* Não leve para o lado pessoal. Ninguém está querendo que você se sinta mal ou deixá-lo(a) desconfortável entre os demais membros da equipe de desenvolvimento.
